...
public interface DataTransferProtocol {
  ...
  public static class Sender {
    ...
    public static void opReadBlock(DataOutputStream out,
        long blockId,long bandwidth, long blockGs, long blockOffset, long blockLen,
      ...
      out.writeLong(bandwidth);//bandwith
  ...
  public static abstract class Receiver {
    ...
    private void opReadBlock(DataInputStream in) throws IOException {
      ...
      final long bandwith = in.readLong();
      final String client = Text.readString(in);
      final BlockAccessToken accesstoken = readAccessToken(in);

      opReadBlock(in, blockId, blockGs, offset, length,bandwith, client, accesstoken);
    }
    ...
    protected abstract void opReadBlock(DataInputStream in,
        long blockId, long blockGs, long offset, long length,long bandwith,
