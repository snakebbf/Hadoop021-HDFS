...
public class DistributedFileSystem extends FileSystem {
  ...
  //Override
  public FSDataInputStream open(Path f,long bandwidth ,int bufferSize) throws IOException {
    return new DFSClient.DFSDataInputStream(
          dfs.open(getPathName(f),bandwidth ,bufferSize, verifyChecksum, statistics));
  }
  ...
  public FSDataInputStream open(Path f,int bufferSize) throws IOException {
    return new DFSClient.DFSDataInputStream(
          dfs.open(getPathName(f),0 ,bufferSize, verifyChecksum, statistics));
  }
