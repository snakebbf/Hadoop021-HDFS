...
class DFSInputStream extends FSInputStream {
  ...
  DFSInputStream(DFSClient dfsClient, String src,long bandwidth, int buffersize, boolean verifyChecksum
  ...
  public void updateInfo() throws IOException, UnresolvedLinkException {
  ...
  private synchronized DatanodeInfo blockSeekTo(long target) throws IOException {
    ...
    while (true) {
      ...
      try {
        ...
        blockReader = BlockReader.newBlockReader(s, src, blk.getBlockId(), bandwidth,
            accessToken, 
    ...
    if (pos < getFileLength()) {
      ...
      while (retries > 0) {
        try {
         ...
         // System.out.println("read:"+result+"pos:"+pos);
  ...
  private void fetchBlockByteRange(LocatedBlock block, long start,
    ...
    while (true) {
      ...
      try {
       ...
       // System.out.println("reading from :" +targetAddr.getAddress());
        ...
        reader = BlockReader.newBlockReader(dn, src, 
                                            block.getBlock().getBlockId(),bandwidth,
                                            accessToken,
