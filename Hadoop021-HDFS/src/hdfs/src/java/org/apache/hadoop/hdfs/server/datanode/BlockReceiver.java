...
import com.coship.hadoop.hdfs.server.socketspeed.SocketBean;
...
//      while (receivePacket() > 0) {}
  ...
  BlockReceiver(Block block, DataInputStream in, String inAddr,
          String myAddr, boolean isRecovery, String clientName, 
          DatanodeInfo srcDataNode, DataNode datanode, SocketBean socketBean) throws IOException {
	  this(block,in,inAddr,myAddr,isRecovery,clientName,srcDataNode,datanode);
