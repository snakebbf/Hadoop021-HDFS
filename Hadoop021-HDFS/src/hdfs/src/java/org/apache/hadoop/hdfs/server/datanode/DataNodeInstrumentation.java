...
public class DataNodeInstrumentation implements MetricsSource {
   ...
   * 	new core 
   */
  final MetricMutableCounterInt numSocket = registry.newCounter("SocketNum", "", 0);
  ...
  public final void incrNumSocket() {
	  numSocket.incr();
  }
  
  public final void miniNumSocket() {
	  numSocket.mini();
  }
  
  public final MetricMutableCounterInt getNumSocket(){
	  return numSocket ;
  }
