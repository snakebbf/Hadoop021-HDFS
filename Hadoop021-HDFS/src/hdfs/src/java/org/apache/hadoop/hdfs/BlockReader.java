...
public class BlockReader extends FSInputChecker {
  ...
  public void updateInfo() throws IOException {
    throw new IOException("updateInfo is not supported in BlockInputChecker");
  }
  ...
  public static BlockReader newBlockReader( Socket sock, String file, long blockId, 
                                     ...
                                     throws IOException {
    return newBlockReader(sock, file, blockId, 0,accessToken, genStamp, startOffset,
                          len, bufferSize, verifyChecksum, "");
  }

  public static BlockReader newBlockReader( Socket sock, String file,
                                     long blockId, long bandwidth,
                                     BlockAccessToken accessToken,
                                     long genStamp,
                                     long startOffset, long len,
                                     int bufferSize, boolean verifyChecksum,
    ...
    DataTransferProtocol.Sender.opReadBlock(
        ...
        blockId,bandwidth, genStamp, startOffset, len, clientName, accessToken);
