...
import com.coship.hadoop.hdfs.server.fileheat.FileInfo;
import com.coship.hadoop.hdfs.server.namenode.SystemActivity;
...
public class NameNode implements ClientProtocol, DatanodeProtocol,
  ...
  */
  ...
  private void initialize(Configuration conf) throws IOException {
    ...
    SystemActivity systemActivity = new SystemActivity(conf); // new core
    FileInfo fileInfo = new FileInfo(conf) ;	// new core
  ...
  public LocatedBlocks getBlockLocations(String src, 
     ...
     * 	@author coship cofs
     * 	new core
     * 	add filoname to fileInfo
     */
    FileInfo.addFile(src); // new core
