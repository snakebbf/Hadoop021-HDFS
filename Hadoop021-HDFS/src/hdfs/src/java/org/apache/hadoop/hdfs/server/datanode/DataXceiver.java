...
class DataXceiver extends DataTransferProtocol.Receiver
  ...
  private BlockTransferThrottler blt =null ;
  ...
  public void run() {
    ...
    try {
      ...
      //get the client bandwidth
     // blt = new BlockTransferThrottler(1024*1024*4);
      ...
      processOp(op, in);
      System.out.println("processOp end");
      ...
      IOUtils.closeSocket(s);
  	  ...
  	  System.out.println("DataXceiveServer run");
  ...
  protected void opReadBlock(DataInputStream in,
    ...
    try {
      ...
      System.out.println("begin sendBlock");
      
      long read = blockSender.sendBlock(out, baseStream,blt); // send data

      System.out.println("end sendBlock");
