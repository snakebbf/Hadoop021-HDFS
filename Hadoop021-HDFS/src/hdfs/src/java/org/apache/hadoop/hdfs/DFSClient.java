...
public class DFSClient implements FSConstants, java.io.Closeable {
  ...
  public DFSInputStream open(String src) 
      throws IOException, UnresolvedLinkException {
    return open(src, 0,conf.getInt("io.file.buffer.size", 4096), true, null);
  }
  ...
  @Deprecated
  public DFSInputStream open(String src, long bandwidth,int buffersize, boolean verifyChecksum,
                             FileSystem.Statistics stats)
      throws IOException, UnresolvedLinkException {
    return open(src,bandwidth, buffersize, verifyChecksum);
  }
  ...
  public DFSInputStream open(String src, int buffersize, boolean verifyChecksum,
                             FileSystem.Statistics stats)
      throws IOException, UnresolvedLinkException {
    return open(src,0, buffersize, verifyChecksum);
  }
  ...
  public DFSInputStream open(String src, long bandwidth,int buffersize, boolean verifyChecksum)
    ...
    return new DFSInputStream(this,src,bandwidth, buffersize, verifyChecksum);
  }
